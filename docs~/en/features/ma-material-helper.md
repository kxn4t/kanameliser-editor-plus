...
When you can spare the effort, merge the target meshes with [Merge Skinned Mesh (Color Menu Safe)](./color-menu-safe-merge) to reduce the load without breaking the color change menu.
